...
If your previous ***CFW*** setup was *EmuNAND-based* and you wish to move the contents of your *EmuNAND/RedNAND** to *SysNAND*, follow [Move EmuNAND](https://3ds.hacks.guide/move-emunand.html) before following this page. If you don't know what an *EmuNAND* is, this doesn't apply to you.
...
1. Update your console by going to System Settings, then "Other Settings", then going all the way to the right and using "System Update"
    ...
    - If this still gives you an error, [follow this troubleshooting guide](https://3ds.hacks.guide/troubleshooting-finalizing-setup.html)
...
2. Press and hold (X), and while holding (X), power on your console. This will launch the Finalizing Setup Helper
    ...
    - If you encounter an error, consult the [troubleshooting](https://3ds.hacks.guide/troubleshooting-finalizing-setup.html) page
...
9. Follow the prompts in the script, answering any questions that you are asked
    ...
    - If you encounter an error, follow the instructions in the error message or consult the [troubleshooting](https://3ds.hacks.guide/troubleshooting-finalizing-setup.html) page
...
For information on using GodMode9's various features, check out the [GodMode9 Usage](https://3ds.hacks.guide/godmode9-usage.html) and [Dumping Titles and Game Cartridges](https://3ds.hacks.guide/dumping-titles-and-game-cartridges.html) pages.